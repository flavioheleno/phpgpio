 ...
 * Stub hash: d1315f9ffb28a4329be62fe19cea4c3bc477fdb2 */

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_GPIO_Line_bias, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_GPIO_Line_consumer, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_class_GPIO_Line_name arginfo_class_GPIO_Line_consumer
...
#define arginfo_class_GPIO_Chip_getLabel arginfo_class_GPIO_Line_consumer

#define arginfo_class_GPIO_Chip_getName arginfo_class_GPIO_Line_consumer
