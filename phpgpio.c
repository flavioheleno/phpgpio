...
PHP_MINIT_FUNCTION(phpgpio) {
  ...
  REGISTER_NS_STRING_CONSTANT("GPIO", "EXTENSION_VERSION", PHP_PHPGPIO_VERSION, CONST_CS | CONST_PERSISTENT);
  REGISTER_NS_STRING_CONSTANT("GPIO", "LIBRARY_VERSION", gpiod_version_string(), CONST_CS | CONST_PERSISTENT);
