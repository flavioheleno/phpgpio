...
PHP_MINIT_FUNCTION(phpgpio) {
  /* Extension constants */
  REGISTER_LONG_CONSTANT("GPIO\\BIAS_UNKNOWN", 1, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\BIAS_DISABLED", 2, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\BIAS_PULL_UP", 3, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\BIAS_PULL_DOWN", 4, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\DIRECTION_INPUT", 1, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\DIRECTION_OUTPUT", 2, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\DRIVE_PUSH_PULL", 1, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\DRIVE_OPEN_DRAIN", 2, CONST_CS | CONST_PERSISTENT);
  REGISTER_LONG_CONSTANT("GPIO\\DRIVE_OPEN_SOURCE", 3, CONST_CS | CONST_PERSISTENT);
